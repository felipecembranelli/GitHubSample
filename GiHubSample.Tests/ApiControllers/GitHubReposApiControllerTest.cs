...
using GitHubSample.Web.SPA;
using GitHubSample.Web.SPA.Controllers;
...
{
    [TestClass]
    public class GithubReposApiControllerTest
    {

        [TestMethod]
        public void GetAllAction_ReturnsListRepositories()
        {
            // Arrange

            //var mockGitHubService = new Mock<IGitHubRepoService>();

            GitHubSample.Data.Repository.IGitHubRepoRepository repo = new GitHubSample.Data.Repository.GitHubRepoRepository(new GitHubSample.Data.Infrastructure.DatabaseFactory());

            var mockUnitOfWork = new Mock<IUnitOfWork>();

            IGitHubRepoService svc = new GitHubSample.Services.GitHubRepoService(repo, mockUnitOfWork.Object);

            GitHubReposApiController controller = new GitHubReposApiController(svc);
